...
public class GreenFieldBowlingGame {
	 ...
	 */
	public GreenFieldGamingFrame[] frames;
	 ...
	 */
	public GreenFieldBowlingGame() {

		this.attempt = 0;
		this.frames = new GreenFieldGamingFrame[MAX_FRAMES];

		// initialize the frames
		for (int i = 0; i < frames.length; i++) {

			this.frames[i] = new GreenFieldGamingFrame();
		}
	}
